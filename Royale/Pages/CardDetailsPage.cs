...
namespace Royale.Pages
{
    public class CardDetailsPage : PageBase
    {
        ...
        public (string Rarity, string Common) GetCardCommon()
        {
            string[] spearator = { "\r\n" }; 
            // Map.CardRarity.Text -- devuelve "Rarity\r\nCommon"
            string[] cardRarity = Map.CardRarity.Text.Split(spearator, StringSplitOptions.RemoveEmptyEntries);            
            return (cardRarity[0].Trim(), cardRarity[1].Trim());
        }
